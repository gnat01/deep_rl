...
def run_experiment(
    ...
    if len(trajectory_counts(config)) == 1:
        plot_single_run_value_vs_gamma(value_plot, exact_rows, mc_rows, mrp.states)
    ...
    plot_trajectory_sweep_value_vs_gamma(
        traj_sweep_value_plot, exact_rows, mc_rows, mrp.states
    )
